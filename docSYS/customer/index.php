            ...
            <table class="menu-container" border="0">
                ...
                <!--<tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor">
                        <a href="doctors.php" class="non-style-link-menu"><div><p class="menu-text">All Members</p></a></div>
                    </td>
                </tr>-->
                ...
                <!--<tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>Haven't any idea about Members? no problem let's jumping to 
